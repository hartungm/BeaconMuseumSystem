...
implementing the FieldLoadSaver or FieldMetadataLoadSaver interface. The
FieldMetadataLoadSaver allows metadata to be set for the document with the
DocumentMetadata type. Struct pointers are more strongly typed and are easier
to use; FieldMetadataLoadSavers are more flexible.
...
The FieldMetadataLoadSaver Interface

A document's contents can also be represented by any type that implements the
FieldMetadataLoadSaver interface. This type may be a struct pointer, but it
